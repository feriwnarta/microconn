...
<section id="we-are-microconn">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 py-0 py-lg-6">
                ...
                <button class="btn btn-lets-talk" width="120px" height="32px">
                    Let's Talk
                </button>
            </div>
            <div class="col-12 offset-lg-2 col-lg-4 ">
                <img src="<?= BASE_URL; ?>/assets/img/amico.svg" class="img-fluid" />
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="image-our-clients col-12 col-lg-12 text-center">
                <img src="<?= BASE_URL; ?>/assets/img/our-clients.svg">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row sub-image">
            <div class="col-12 col-lg-4">
                <img src="<?= BASE_URL; ?>/assets/img/sample-foto.svg" alt="">
